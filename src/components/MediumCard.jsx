...
<Row>
    ...
    <div >
          <Image src={img41} layout="fill" style={{height:'300px',width:'100%'}} />  
...
<div>
<h2 style={{fontize: '27px',marginTop: '20px',marginRigh: '30px',fontWeight:'500px'}}><strong>Inspiration for future get ways</strong></h2>
        <div className="row" style={{fontSize: '13px',marginTop:'15px',color:'grey',marginRight: '200px'}}>
        ...
        <hr/>
        <div id="row">
            <div class="row" style={{marginRight: '200px',color:'grey',fontSize:'13px'}}>
            ...
            <div class="row"  style={{marginRight: '200px',marginTop:'12px',color:'grey',fontSize:'13px'}}>
